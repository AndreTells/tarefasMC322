...
public class SubMenuListener implements MouseListener{
	...
	public SubMenuListener(IActor actor,SubMenu menu,IContainer ui) {
		this.actor = actor;
		this.menu = menu;
		this.ui = ui;
	}
	...
	public void mouseClicked(MouseEvent e) {
		...
		int [] pos = menu.getPos(screen_dims[0], screen_dims[1]);
		int [] btn_dims = menu.getDims(screen_dims[0], screen_dims[1]);
